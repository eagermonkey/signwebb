...
/***** *****/
define("PROJECTS_SECTION", 2);
define("SERVICES_SECTION", 3);
define("OUR_STRATEGY_SECTION", 4);
define("NEWS_SECTION", 5);
define("TESTIMONIALS_SECTION", 6);

define("ABOUT_PAGE", 19);

define("CLIENTS_FOLDER", "clients");
define("HOMEPAGE_IMAGES", "homepage");
define("CAROUSEL_IMAGE_WIDTH", 785);